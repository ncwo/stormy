...
public class DescriptionComponent implements Component {
	...
	public void draw() {
		...
		Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(this.desc.getDesc(), (this.p.category.getX() + 4) * 2, (this.p.category.getY() + this.o + 4) * 2, Theme.getMainColor().getRGB());
		GL11.glPopMatrix();
	}
