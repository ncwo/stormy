...
public class TickComponent implements Component {
	...
	public void draw() {
		...
		Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(this.cl1ckbUtt0n.isToggled() ? "[+]  " + this.cl1ckbUtt0n.getName() : "[-]  " + this.cl1ckbUtt0n.getName(), (this.module.category.getX() + 4) * 2, (this.module.category.getY() + this.o + 5) * 2, this.cl1ckbUtt0n.isToggled() ? Theme.getMainColor().getRGB() : -1);
