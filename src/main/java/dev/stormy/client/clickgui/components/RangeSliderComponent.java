...
public class RangeSliderComponent implements Component {
	...
	public void draw() {
		...
		Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(this.doubleSlider.getName() + ": " + this.doubleSlider.getInputMin() + ", " + this.doubleSlider.getInputMax(), ((int) ((this.module.category.getX() + 4) * 2.0F)), ((int) ((this.module.category.getY() + this.moduleStartY + 3) * 2.0F)), -1);
		GL11.glPopMatrix();
	}
	...
	public void update(int mousePosX, int mousePosY) {
		...
		this.blankWidth = (this.module.category.getWidth() - boxMargin * 2) * (this.doubleSlider.getInputMin() - this.doubleSlider.getMin()) / (this.doubleSlider.getMax() - this.doubleSlider.getMin());
		this.barWidth = (this.module.category.getWidth() - boxMargin * 2) * (this.doubleSlider.getInputMax() - this.doubleSlider.getInputMin()) / (this.doubleSlider.getMax() - this.doubleSlider.getMin());
			...
			if (mousePressedAt > blankWidth + barWidth / 2 || mode == Helping.MAX) {
				...
				if (this.mode == Helping.MAX) {
					if (mousePressedAt <= blankWidth) {
						...
						double n = r(mousePressedAt / (this.module.category.getWidth() - boxMargin * 2) * (this.doubleSlider.getMax() - this.doubleSlider.getMin()) + this.doubleSlider.getMin(), 2);
