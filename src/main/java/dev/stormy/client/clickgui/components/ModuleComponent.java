...
public class ModuleComponent implements Component {
	...
	@Override
	public void draw() {
		v(this.category.getX(), this.category.getY() + this.o, this.category.getX() + this.category.getWidth(), this.category.getY() + 15 + this.o, this.mod.isEnabled() ? Theme.getMainColor().getRGB() : -12829381, this.mod.isEnabled() ? Theme.getMainColor().getRGB() : -12302777);
		GL11.glPushMatrix();
		int button_rgb;
		...
		Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(this.mod.getName(), this.category.getX() + this.category.getWidth() / 2 - Minecraft.getMinecraft().fontRendererObj.getStringWidth(this.mod.getName()) / 2, this.category.getY() + this.o + 4, button_rgb);
		GL11.glPopMatrix();
