...
public class SafeWalk extends Module {
	...
	public SafeWalk() {
		...
		this.registerSetting(shiftTime = new DoubleSliderSetting("Shift time: (s)", 30, 60, 0, 280, 5));
		...
		this.registerSetting(lookDown = new TickSetting("Only when looking down", false));
		this.registerSetting(pitchRange = new DoubleSliderSetting("Pitch min range:", 0D, 0D, 0D, 90D, 1D));
	}
	...
	public void onTick(TickEvent e) {
		if (ClientUtils.currentScreenMinecraft() || !PlayerUtils.isPlayerInGame()) {
			return;
		}
