...
public class WTap extends Module {
	...
	public WTap() {
		...
		this.registerSetting(range = new SliderSetting("Range", 3.3D, 0.0D, 6.0D, 0.1D));
		this.registerSetting(chance = new SliderSetting("Chance", 100.0D, 0.0D, 100.0D, 1.0D));
		this.registerSetting(delay = new DoubleSliderSetting("Delay", 80.0D, 120.0D, 0.0D, 300.0D, 5.0D));
	}
