...
public class Bhop extends Module {
	...
	public Bhop() {
		...
		this.registerSetting(gs = new SliderSetting("Ground Speed (New)", 1.0D, 1.0D, 2.0D, 0.01D));
		this.registerSetting(as = new SliderSetting("Air Speed (New)", 1.0D, 1.0D, 5.0D, 0.01D));
		this.registerSetting(hitRec = new TickSetting("Slow on hit recieve (New)", false));
