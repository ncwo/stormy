...
public class Utils {
	...
	public static class Distance {
		/**
		 * Credit: @AriaJackie/Fractal Calculates the distance to the entity.
		 *
		...
		/**
		 * Credit: @AriaJackie/Fractal Calculates the distance to the specified
		 * positions.
		 *
		...
		public static void d3p(double x, double y, double z, double radius, int sides, float lineWidth, int color, boolean chroma) {
			...
			for (int i = 0; i < sides * 2; ++i) {
				if (chroma) {
					...
					float r2 = (c >> 16 & 255) / 255.0F;
					float g2 = (c >> 8 & 255) / 255.0F;
					float b2 = (c & 255) / 255.0F;
